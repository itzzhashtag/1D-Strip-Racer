/*
 * ================================================================
 *  LED RACE  —  ESP32 Edition  v5
 *
 *  FIXES in v5:
 *    1. Lap stutter removed — TM1637 write is decoupled from physics
 *       via a dirty flag; display updates once per loop tick, not
 *       inside the per-player physics block.
 *    2. Win entry: all players freeze → fade-in green → cross-fade
 *       to winner's colour → then jingle / idle.
 *    3. Countdown beats are millis()-paced so every beat (3/2/1/GO)
 *       takes EXACTLY COUNTDOWN_BEAT_MS, gap included.
 *
 *  WIRING / LIBRARIES  — same as v4
 * ================================================================
 */
...
// ================================================================
//  REMOTE SENDER — flash on second ESP32
// ================================================================
/*
...
uint8_t RECEIVER_MAC[] = {0xAA,0xBB,0xCC,0xDD,0xEE,0xFF};  // ← main ESP32 MAC
